...
:loop
claude --model opus --effort xhigh --dangerously-skip-permissions --strict-mcp-config --mcp-config .mcp-lulu.json --dangerously-load-development-channels server:lulu
